(function($) {
    ...
    function sinAndCos() {
        ...
        var $notes = $('#line-chart').data('notes');
        var $favorites = $('#line-chart').data('favorites');
        var $comments = $('#line-chart').data('comments');
        var arrayNotes = $notes.split(',');
        var arrayFavs = $favorites.split(',');
        var arrayComs = $comments.split(',');
        var notes = [],
            favorites = [],
            comments = [];
        for (i = 0; i < 10; i++) {
    ...
    nv.addGraph(function() {
        ...
        lineChart.xAxis.axisLabel('Days').tickFormat(d3.format());
        lineChart.xAxis.tickFormat(d3.format(',r'));
        lineChart.yAxis.axisLabel('Quantity').tickFormat(d3.format());
        lineChart.yDomain([0,50]);
