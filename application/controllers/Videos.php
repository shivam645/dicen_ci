...
class Videos extends CI_Controller
{
    ...
    public function uploadAmazonS3File($idVideo, $type)
    {
        ...
        if (isset($_FILES['userFile']))
        {
         ...
         // print_r($data['s3_details']); echo 'simple <br>';print_r($config); // echo '<br>';print_r($uploaded_files);
    ...
    public function uploadAmazonS3BrowserFile($idVideo, $type)
    {
      ...
      //  print_r($data['s3_details']); echo '<br>';print_r($config); echo '<br>';print_r($uploaded_files);
