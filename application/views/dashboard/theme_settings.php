                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
	                                ...
	                                <div>
                                      <label for="footerMenu1Show"><input type="checkbox" id="footerMenu1Show" name="footerMenu1Show" value="1" <?php echo $this->config->item('footerMenu1Show')?'checked="checked"':''; ?> /> <?php echo $this->lang->line('Show'); ?></label>
                                  	</div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="backgroundLogin"><?php echo $this->lang->line('Menu 2'); ?></label>
                                  	<div>
                                      <label for="footerMenu2Show"><input type="checkbox" id="footerMenu2Show" name="footerMenu2Show" value="1" <?php echo $this->config->item('footerMenu2Show')?'checked="checked"':''; ?> /> <?php echo $this->lang->line('Show'); ?></label>
                                  	</div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
	                                ...
	                                <div>
                                      <label for="footerMenu3Show"><input type="checkbox" id="footerMenu3Show" name="footerMenu3Show" value="1" <?php echo $this->config->item('footerMenu3Show')?'checked="checked"':''; ?> /> <?php echo $this->lang->line('Show'); ?></label>
                                  	</div>
