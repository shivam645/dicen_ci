                ...
                <div class="col-sm-12 <?php echo ($this->config->item('hasSidebar') === '0') ? 'col-lg-12' : 'col-lg-8'; ?>">
                    ...
                    <?php } elseif ($seg = $this->uri->segment(2) === 'history') { ?>
                        <div class="card-box">
                            ...
                            <span style="font-size:13px" >Note: if you want to chancel your subscription, just click on the green active button, a popup will open and will show you cancel subscription link. Click "Cancel Subscription" to cancel your subscription!</span>
                                <table class="table table-striped m-0 text-center">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?php echo $this->lang->line('Type'); ?></th>
                                            <th style="display:none;" class="text-center"><?php echo $this->lang->line('Reference'); ?></th>
                                            ...
                                            <div class="col-sm-4 p-b-20">
                                                    <div class="price_card price-box-4 <?php if ($this->config->item('planFocus') === '1') echo 'active'; ?>">
                                                        ...
                                                        <div class="price-features">
                                                         ...
                                                         <h5><a href="<?php echo site_url('user/history/'.$url.'/'); ?>">Cancel Subscription</a></h5>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body p-0">
                                                            <form action="<?php echo current_url(); ?>" method="post">
                                                                ...
                                                                <button type="submit" class="btn btn-block custom-button-el waves-effect waves-light btn-md m-t-20">
...
window.onload = function() {
    $('.price_card button').click(function () {
        ...
        $('#modal h2').html(text);
        $('#modal button .dynamic-price').html(price);
    }); 
