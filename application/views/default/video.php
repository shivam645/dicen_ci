                            ...
                            <?php if($subscription === "1" && $this->session->subscriber !== true) { ?>
                                <div class="video-header text-center">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-md-offset-4">
                                        <a href="<?php echo ($this->session->url) ? site_url('user/subscription/' . $this->session->url . '/') : site_url('login/register/'); ?>" class="btn btn-green btn-slider waves-effect waves-light btn-lg"><?php echo $this->lang->line('Sign Up Now To Become A Subscriber') ?></a>
                                ...
                                <?php if ($type === '1' || $type === '2' || $type === '3'|| $type === '4') { ?>
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <div id="video-player"
                                            ...
                                            data-color="<?php echo ((!empty($this->config->item('vplColor'))) ? $this->config->item('vplColor') : '#68b54d'); ?>">
                                        </div>
                                    </div>
                                <?php } else { ?>
                                    <div class="embed-responsive embed-responsive-16by9">
                ...
                <div class="video-title">
                    <div class="video-title-right">
                        ...
                        <?php if(isset($this->session->id)) { ?>
                            <a href="<?php echo site_url('video/'.$url.'/?fav='.(($getFav === 1) ? 'del' : 'add')); ?>" class="btn btn-inverse waves-effect waves-light"> <i class="<?php echo ($getFav === 1) ? 'fa fa-heart' : 'fa fa-heart-o'; ?> m-r-5"></i><span> <?php echo ($getFav === 1) ? $this->lang->line('favorite')  : $this->lang->line('favorite') ?></span></a>
                        <?php } else { ?>
                            <button class="btn btn-inverse waves-effect waves-light sa-not-registed"><i class="fa fa-heart-o m-r-5"></i><span> <?php echo $this->lang->line('favorite'); ?></span></button>
                        <?php } ?>
                    </div>
                    ...
                    <div>
                        ...
                        <button
                            ...
                            data-content='<form method="post" action="<?php echo current_url(); ?>">
                                              ...
                                              <input type="submit" name="submitPlaylist" value="Submit" class="btn btn-inverse btn-block waves-effect waves-light">
                                          </form>'
                            data-original-title="">
