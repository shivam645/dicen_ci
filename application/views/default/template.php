...
<meta name="twitter:site" content="shahnice">
<meta name="twitter:description" content="<?php if(isset($ogDescription)) echo mb_strimwidth(strip_tags($ogDescription), 0, 300, '...'); ?>">
<meta name="twitter:image" content="<?php if(isset($ogImage)) echo $ogImage; ?>">
    <!-- Favicon -->
...
<body class="fixed-left front">
				...
				<div class="container container-mobile">
					<div class="row">
						<div class="col-sm-12 col-md-4 footer-widget-box">
                      	...
                      	<?php
                            $footerMenu1Show = false;
                            $footerMenu2Show = false;
                            $footerMenu3Show = false;
                            $footerMenues = 0;
                            $col = 0;

                            if($this->config->item('footerMenu1Show')=='1') {
                                $footerMenu1Show = true;
                                $footerMenues++;
                            }
                            if($this->config->item('footerMenu2Show')=='1') {
                                $footerMenu2Show = true;
                                $footerMenues++;
                            }
                            if($this->config->item('footerMenu3Show')=='1') {
                                $footerMenu3Show = true;
                                $footerMenues++;
                            }
                            if($footerMenues==3) {
                                $col = 4;
                            }
                            else if($footerMenues==2) {
                                $col = '5 col-md-offset-1';
                            }
                            else if($footerMenues==1) {
                      	...
                      	<div class="col-sm-12 col-md-8">
						    <div class="row">
                              <?php
                                if($footerMenu1Show) {
                                    ?>
                                    <div class="col-sm-12 col-md-<?php echo $col; ?> footer-widget-box">
    ...
    <?php if ($this->uri->segment(1) === 'video') { ?>
        <script src="<?php echo site_url('assets/js/hls.js'); ?>"></script>
